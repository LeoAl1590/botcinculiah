...
conn.welcome = ''
conn.bye = ''
conn.spromote = '*@user Ahora sos admin del grupo*'
conn.sdemote = '*@user Ya no sos admin del gurpo*'
conn.sDesc = '*Cambiaron la descripcion del grupo*\n\n*Nueva descripcion:* @desc'
conn.sSubject = '*Se cambio el nombre del grupo*\n*Nuevo grupo:* @subject'
conn.sIcon = '*Cambiaron la foto del grupo*'
conn.sRevoke = '*Renovaron el link del grupo*\n*Nuevo link:* @revoke'
